...
local _M =
{
	...
	-- Aesthetic
	lang = os.getenv('DEFAULT_LANG') or 'vi_VN',
	commit = os.getenv("GB_COMMIT"),
	channel = os.getenv("GB_CHANNEL") or '@kenhsex',
	source_code = os.getenv("GB_SOURCE") or 't.me/kuri69',
	help_group = os.getenv('HELP_GROUP') or 'telegram.me/nangcuc',
